<?php
namespace SpoonerWeb\Justevents\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class SpoonerWeb\Justevents\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \SpoonerWeb\Justevents\Controller\EventController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('SpoonerWeb\\Justevents\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView() {
		...
		$eventRepository = $this->getMock('SpoonerWeb\\Justevents\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
